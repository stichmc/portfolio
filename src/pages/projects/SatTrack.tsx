          ...
          <div className="flex flex-col text-black p-8 rounded-2xl shadow-lg bg-white mt-2 sm:mt-[-2rem]">
            ...
            <div className="mt-6 sm:mt-0">
              ...
              <p className="text-sm sm:text-xl mb-8">
                ...
                the comfort of their screens. Whether you're interested in spotting the International Space Station
                (ISS), the Hubble Space Telescope, or any other satellite, Sat-Track has you covered. My team and I
                developed this entire project in 24 hours at HackCU 2024.
              </p>

              <div className="mb-8 items-center md:flex">
                <div className="md:w-1/2">
                  <h1 className="text-xl sm:text-2xl font-bold mb-4">Globe:</h1>
                  <p className="text-sm sm:text-xl mb-8">
                    This labor of love, this globe rendered by Three.js took a majority of our time. The satellite data
                    we receive from our external apis give us all the positioning and velocity variables we needed to
              ...
              <div className="mb-8 items-center md:flex">
                ...
                <div className="md:w-1/2 mt-4">
                  ...
                  <p className="text-sm sm:text-xl mb-8">
                    ...
                    input it into the control panel and add it to our tracked satellites list. This will also allow you
                    to see the satellite's position on the globe.
                  </p>
                </div>
              </div>
              ...
              <div className="technical-details-section mt-4">
                <h1 className="text-xl sm:text-2xl font-bold mb-4">Technology:</h1>
                <ul className="list-disc">
                  <li className="text-sm sm:text-lg">
