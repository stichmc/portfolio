...
const Beyond = () => {
  ...
  return (
    <>
      <Navbar isHome={false} isEducation={false} isProjects={false} />
          ...
          <div className="text-black p-8 rounded-md shadow-lg max-w-full ">
            ...
            <div className="grid gap-8">
              <div className="p-8 max-w-5xl mx-auto">
                <h1 className="text-3xl font-bold mb-4">Bringing fun back to adventure games</h1>
                <p className="text-gray-700 mb-8">
                  Beyond is a 2D pixel game passion project that I have been working on for a long time. It's
                  inspiration stems from my love of space style games and my passion for playing adventure games.
                </p>
