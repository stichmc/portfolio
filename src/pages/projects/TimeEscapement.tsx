          ...
          <FadeIn>
            <div className="flex flex-col text-black p-8 rounded-2xl shadow-lg bg-white mt-2 sm:mt-[-2rem]">
              <div className="flex justify-between items-center">
                ...
                <div className="w-40 h-24 sm:w-36 sm:h-36 transition-transform transform hover:scale-105 shadow-2xl rounded-full flex items-center justify-center">
              ...
              <div className="mt-6 sm:mt-0">
                ...
                <div className="mb-4 block items-center md:flex">
                  <div className="md:w-1/2 md:pr-8">
                    <img src={timeEscapementPicture} alt="Time Escapement Picture" className="rounded-2xl" />
                  </div>

                  <div className="mt-4 sm:mt-0">
                    <h1 className="text-xl sm:text-3xl font-bold mb-4">Project Details:</h1>
                    <ul className="list-disc text-sm sm:text-lg">
                      ...
                      <li>
                        <strong>Time Escapement Design:</strong> Designed and constructed a 17th-century time
                        escapement, serving as a visual teaching aid for the Physics Professor.
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Budget Management:</strong> Accomplished the project within the allocated budget of
                        $250, demonstrating efficient resource utilization.
                      </li>
                    </ul>
                  </div>
                </div>
